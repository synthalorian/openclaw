...
export const es: TranslationMap = {
  ...
  subtitles: {
    ...
    memory: "Motor de memoria, backend, búsqueda y soñar.",
  ...
  memoryPage: {
    ...
    engine: {
      title: "Motor",
      description:
        "Exactamente un complemento de memoria ocupa la ranura de memoria. Al seleccionar un motor se habilita y se deshabilitan los demás.",
      ...
      disabledHint:
        "La ranura de memoria apunta a este complemento, pero el complemento en sí está deshabilitado, por lo que la memoria no está en ejecución.",
      enable: "Activar",
    },
    backend: {
      title: "Backend",
    ...
    addons: {
      title: "Complementos",
      description:
        "Estos plugins se superponen al motor en lugar de competir por el espacio, por lo que cualquier combinación puede ejecutarse a la vez.",
      activeMemory: {
    ...
    dreaming: {
      intro:
        "El soñado se ejecuta como un único trabajo cron gestionado en todos los espacios de trabajo de agentes, por lo que estos ajustes son globales. Son propiedad del plugin {plugin}.",
      schedule: {
        title: "Programación",
      ...
      frequency: {
        ...
        help: "Cadencia cron para el barrido completo de soñado (ligero, REM, luego profundo). Déjalo vacío para el valor predeterminado del plugin.",
        placeholder: "0 3 * * *",
      },
      timezone: {
        label: "Zona horaria",
      ...
      verboseLogging: {
        ...
        help: "Registra cada fase de sueño en detalle. Útil al ajustar los umbrales.",
      },
      storage: {
      ...
      phases: {
        light: {
          title: "Fase ligera",
          description:
            "Pasada económica de actividad reciente que prepara candidatos de repetición.",
        },
        deep: {
          title: "Fase profunda",
          description:
            "Pasada de promoción puntuada que gradúa las entradas de corto plazo a memoria.",
        },
        rem: {
          title: "Fase REM",
          description:
      ...
      phaseFields: {
        ...
        lookbackDaysHelp:
          "Cuánto tiempo hacia atrás lee esta fase. Déjalo vacío para usar el valor predeterminado del plugin.",
        limit: "Límite",
        ...
        minRecallCountHelp:
          "Con qué frecuencia debe recuperarse una entrada antes de que pueda promoverse.",
      ...
      agentScope: {
        ...
        description:
          "Los ajustes anteriores son globales. El diario de sueños, los recuentos a corto plazo y las acciones de mantenimiento que aparecen a continuación pertenecen a un solo agente.",
        rowTitle: "Agente",
      },
      unsupported: {
        ...
        description:
          "El plugin {plugin} controla la ranura de memoria y su esquema de configuración no tiene sección de sueños, por lo que estos ajustes no se pueden almacenar. Cambia el motor en la pestaña Descripción general para editarlos.",
      },
    },
  },
  sessionsPage: {
  ...
  labsPage: {
    ...
    toolSearch: {
      ...
      description:
        "Mantén visible un directorio de herramientas acotado y deja el resto detrás de la búsqueda, para que los grandes catálogos de MCP y plugins dejen de saturar el prompt.",
    },
    localModelLean: {
      title: "Herramientas ligeras para modelos locales",
      description:
        "Descarta las herramientas predeterminadas pesadas que los modelos locales más pequeños manejan mal, dejando un conjunto más corto que puedan usar de forma fiable.",
    },
    auditMessages: {
  ...
  dreaming: {
    ...
    toggleConfirmation: {
      ...
      enableTitle: "Activar el sueño para todos los agentes",
      enableDetail:
        "El barrido nocturno de sueños se ejecutará en todos los espacios de trabajo de agente configurados, promoviendo los recuerdos a corto plazo a memoria a largo plazo. Esto se aplica de inmediato.",
      enableConfirm: "Activar el sueño",
      disableTitle: "Desactivar el sueño para todos los agentes",
      disableDetail:
        "El barrido nocturno de sueños se detendrá para todos los agentes configurados, no solo para este. Los recuerdos ya escritos permanecen; no se promueve nada nuevo. Esto se aplica de inmediato.",
