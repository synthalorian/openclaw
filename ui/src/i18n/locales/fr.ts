...
export const fr: TranslationMap = {
  ...
  memoryPage: {
    ...
    engine: {
      title: "Moteur",
      description:
        "Un seul plugin de mémoire occupe l'emplacement mémoire. Sélectionner un moteur l'active et désactive les autres.",
      ...
      disabledHint:
        "L'emplacement mémoire pointe vers ce plugin, mais le plugin lui-même est désactivé, donc la mémoire ne fonctionne pas.",
      enable: "Activer",
    },
    backend: {
      title: "Backend",
    ...
    addons: {
      ...
      description:
        "Ces plugins s'ajoutent par-dessus le moteur au lieu de se disputer l'emplacement, de sorte que n'importe quelle combinaison peut s'exécuter simultanément.",
      activeMemory: {
    ...
    search: {
      intro:
        "Paramètres par défaut d'embedding et de récupération partagés par tous les agents qui n'ont pas de remplacement de mémoire.",
    },
    dreaming: {
      intro:
        "Le rêve s'exécute comme une seule tâche cron gérée sur tous les espaces de travail d'agent, ces paramètres sont donc globaux. Ils sont gérés par le plugin {plugin}.",
      schedule: {
        title: "Planification",
      ...
      frequency: {
        ...
        help: "Cadence cron pour le balayage complet de rêve (léger, REM, puis profond). Laissez vide pour la valeur par défaut du plugin.",
        placeholder: "0 3 * * *",
      },
      timezone: {
      ...
      model: {
        ...
        help: "Remplacement du fournisseur/modèle pour la narration du journal de rêves. Nécessite l'autorisation des remplacements de modèle du sous-agent.",
        placeholder: "anthropic/claude-sonnet-4-6",
      },
      verboseLogging: {
        label: "Journalisation détaillée",
        help: "Journaliser chaque phase de rêve en détail. Utile pour ajuster les seuils.",
      },
      storage: {
        title: "Stockage",
      ...
      phases: {
        ...
        rem: {
          title: "Phase REM",
          description:
            "Passe de motifs qui recherche les thèmes récurrents sur la fenêtre de rétrospection.",
        },
      },
      phaseFields: {
        enabled: "Activé",
        enabledHelp: "Exécuter cette phase pendant le balayage.",
        lookbackDays: "Jours de rétrospective",
        lookbackDaysHelp:
          "Jusqu'à quand cette phase remonte dans le passé. Laissez vide pour la valeur par défaut du plugin.",
        limit: "Limite",
        ...
        minUniqueQueriesHelp: "Nombre de requêtes distinctes ayant dû faire apparaître l'entrée.",
        recencyHalfLifeDays: "Demi-vie de récence (jours)",
        recencyHalfLifeDaysHelp:
          "Vitesse à laquelle les anciens signaux de rappel perdent de leur poids.",
        maxAgeDays: "Âge maximal (jours)",
        maxAgeDaysHelp: "Ignorer les entrées à court terme plus anciennes que cette valeur.",
        maxPromotedSnippetTokens: "Tokens max des extraits promus",
        maxPromotedSnippetTokensHelp:
          "Budget de tokens pour chaque extrait promu. La provenance reste attachée.",
        minPatternStrength: "Force de motif minimale",
        minPatternStrengthHelp: "Force qu'un motif récurrent doit atteindre pour être signalé.",
      },
      agentScope: {
        title: "Vue de l'agent",
        description:
          "Les paramètres ci-dessus sont globaux. Le journal de rêves, les compteurs à court terme et les actions de maintenance ci-dessous appartiennent à un seul agent.",
        rowTitle: "Agent",
      },
      unsupported: {
        ...
        description:
          "Le plugin {plugin} détient l'emplacement mémoire et le schéma de configuration ne comporte aucune section de rêve, ces paramètres ne peuvent donc pas être stockés. Changez de moteur dans l'onglet Vue d'ensemble pour les modifier.",
      },
    },
  },
  sessionsPage: {
  ...
  labsPage: {
    ...
    toolSearch: {
      ...
      description:
        "Gardez visible un répertoire d'outils délimité et différez le reste derrière la recherche, afin que les vastes catalogues MCP et de plugins n'encombrent plus l'invite.",
    },
    localModelLean: {
      title: "Outils allégés pour les modèles locaux",
      description:
        "Supprimez les outils par défaut lourds que les petits modèles locaux gèrent mal, ne laissant qu'un ensemble plus court qu'ils peuvent utiliser de façon fiable.",
    },
    auditMessages: {
  ...
  dreaming: {
    ...
    toggleConfirmation: {
      ...
      enableDetail:
        "Le balayage nocturne de rêve s'exécutera sur chaque espace de travail d'agent configuré, promouvant les souvenirs à court terme en mémoire à long terme. Cela s'applique immédiatement.",
      enableConfirm: "Activer le rêve",
      disableTitle: "Désactiver le rêve pour tous les agents",
      disableDetail:
        "Le balayage nocturne de rêverie s'arrêtera pour chaque agent configuré, et pas seulement celui-ci. Les souvenirs déjà écrits sont conservés ; rien de nouveau n'est promu. Cela s'applique immédiatement.",
      disableConfirm: "Désactiver la rêverie",
      saving: "Enregistrement…",
  ...
  chat: {
    ...
    sessionRoute: {
      ...
      additionalMatches: "Il reste des résultats de recherche. Utilisez un préfixe d'id plus long.",
    },
    sessionSharing: {
