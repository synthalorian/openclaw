...
export const pt_BR: TranslationMap = {
  ...
  memoryPage: {
    ...
    engine: {
      title: "Motor",
      description:
        "Exatamente um plugin de memória ocupa o slot de memória. Selecionar um motor o ativa e desativa os demais.",
      rowTitle: "Motor de memória",
      off: "Desativada",
      autoHint:
        "Nenhum motor está fixado na configuração, então o slot recorre ao proprietário padrão.",
      ...
      disabledTitle: "Este motor está desativado",
      disabledHint:
    ...
    backend: {
      title: "Backend",
      description: "Como a memória é armazenada e recuperada para o motor selecionado.",
    ...
    addons: {
      title: "Complementos",
      description:
        "Esses plugins se sobrepõem ao mecanismo em vez de competir pelo espaço, então qualquer combinação pode ser executada ao mesmo tempo.",
      activeMemory: {
        title: "Memória ativa",
      },
      memoryWiki: {
    ...
    dreaming: {
      intro:
        "O Dreaming é executado como um único cron job gerenciado em todos os espaços de trabalho de agentes, então essas configurações são globais. Elas pertencem ao plugin {plugin}.",
      schedule: {
        title: "Agendamento",
      ...
      model: {
        ...
        help: "Substituição de provedor/modelo para a narração do diário de sonhos. Requer que as substituições de modelo de subagente sejam permitidas.",
        placeholder: "anthropic/claude-sonnet-4-6",
      },
      verboseLogging: {
        label: "Log detalhado",
        help: "Registra cada fase do dreaming em detalhes. Útil ao ajustar limites.",
      },
      storage: {
        title: "Armazenamento",
        description: "Onde as memórias promovidas e os relatórios de dreaming são gravados.",
        ...
        separateReportsHelp:
          "Mantém os relatórios de dreaming fora do arquivo de memória principal.",
      },
      phases: {
        light: {
          title: "Fase leve",
        ...
        rem: {
          title: "Fase REM",
          description:
            "Passagem de padrões que procura temas recorrentes na janela de retrospectiva.",
        },
      },
      phaseFields: {
        enabled: "Ativado",
        enabledHelp: "Executa esta fase durante a varredura.",
        lookbackDays: "Dias de retrospectiva",
        lookbackDaysHelp:
          "Até onde esta fase lê no passado. Deixe vazio para usar o padrão do plugin.",
        limit: "Limite",
      ...
      unsupported: {
        ...
        description:
          "O plugin {plugin} possui o slot de memória e seu esquema de configuração não tem uma seção de sonho, então essas configurações não podem ser armazenadas. Troque o mecanismo na aba Visão geral para editá-las.",
      },
    },
  },
  sessionsPage: {
  ...
  labsPage: {
    ...
    toolSearch: {
      ...
      description:
        "Mantenha visível um diretório de ferramentas limitado e adie o restante por trás da busca, para que catálogos grandes de MCP e plugins parem de sobrecarregar o prompt.",
    },
    localModelLean: {
      title: "Ferramentas enxutas para modelos locais",
      description:
        "Remova ferramentas padrão pesadas que modelos locais menores lidam mal, deixando um conjunto mais curto que eles conseguem usar com confiabilidade.",
    },
    auditMessages: {
      title: "Metadados de auditoria de mensagens",
      description:
        "Registre metadados sem conteúdo para conversas diretas no livro-razão de auditoria. O conteúdo das mensagens nunca é armazenado.",
    },
  },
  aboutPage: {
  ...
  dreaming: {
    ...
    toggleConfirmation: {
      subtitle: "Sonho é uma configuração global; não é restrita a este agente.",
      enableTitle: "Ativar sonho para todos os agentes",
      enableDetail:
        "A varredura noturna de sonho será executada em todos os workspaces de agente configurados, promovendo memórias de curto prazo para a memória de longo prazo. Isso se aplica imediatamente.",
      enableConfirm: "Ativar sonho",
      disableTitle: "Desativar sonho para todos os agentes",
      disableDetail:
        "A varredura noturna de sonho será interrompida para todos os agentes configurados, não apenas este. As memórias já gravadas permanecem; nada novo será promovido. Isso se aplica imediatamente.",
