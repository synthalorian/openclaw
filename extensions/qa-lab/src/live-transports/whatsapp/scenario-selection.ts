// These are the live WhatsApp runner defaults. The retired `whatsapp:adapter`
// YAML membership was test-only and never drove this selector.
const WHATSAPP_QA_DEFAULT_SCENARIO_IDS = [
  "whatsapp-canary",
...
export function resolveWhatsAppQaScenarioIds(params: {
  ...
  return params.providerMode === "mock-openai"
    ...
    : [...WHATSAPP_QA_DEFAULT_SCENARIO_IDS];
}
